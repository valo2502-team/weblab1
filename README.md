...
Ця команда збере Python-образ, завантажить PostgreSQL, автоматично застосує міграції бази даних та запустить сервер. Виконувати команду в папці застосунку.
```bash
docker compose up --build
```

Ця команда запустить образ без перезбірки.
```bash
docker compose up
```
